...
from .c_types import Seq, X, Y, Dataset, I2W, W2I
...
def load_imdb(final=False, val=5000, seed=0, voc=None, char=False) -> tuple[Dataset, Dataset, tuple[I2W, W2I], Literal[2]]:
